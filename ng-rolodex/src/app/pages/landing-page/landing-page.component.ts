...
export class LandingPageComponent implements OnInit {
  ...
  mouseEnter(){
    // document.getElementById('pic').src = 'http://gif-finder.com/wp-content/uploads/2015/12/Tim-Eric-Mind-Blown.gif'
    document.getElementById('pic').src = this.memes[Math.floor(Math.random()*this.memes.length)]
  }
  mouseLeave(){
    // document.getElementById('pic').src = 'http://i.imgur.com/oQ2yUwA.gif'
    document.getElementById('pic').src = this.memes[Math.floor(Math.random()*this.memes.length)]}
